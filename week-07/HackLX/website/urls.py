...
from .views import get_statistics, RegisterView, CreateOfferView, UpdateOfferView, DeleteOfferView, OfferListView, PendingOffersView, ApprovedAndRejectedOffers
